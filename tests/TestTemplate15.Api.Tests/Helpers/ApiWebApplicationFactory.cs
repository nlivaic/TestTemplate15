        ...
        IAsyncLifetime
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureTestServices(services =>
            {
                ...
                var ctx = scopedServices.GetRequiredService<TestTemplate15DbContext>();
        ...
        public TestTemplate15DbContext CreateDbContext(ITestOutputHelper testOutput = null)
        {
        ...
        {
            private readonly DbContextOptions<TestTemplate15DbContext> _options;
            ...
            {
                _options = new DbContextOptionsBuilder<TestTemplate15DbContext>()
            ...
            public TestTemplate15DbContext BuildContext() =>
                new(_options);
        }
    }
}
