...
using TestTemplate15.Common.MessageBroker.Middlewares.ErrorLogging;
using TestTemplate15.Common.MessageBroker.Middlewares.Tracing;
using TestTemplate15.Core;
using TestTemplate15.Core.Events;
using TestTemplate15.Data;
using TestTemplate15.WorkerServices.FaultService;
using TestTemplate15.WorkerServices.FooService;
...
namespace TestTemplate15.WorkerServices
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            try
            {
                Log.Information("Starting up TestTemplate15 Worker Services.");
            ...
            {
                Log.Fatal(ex, "TestTemplate15 Worker Services failed at startup.");
            }
            finally
            {
                Log.CloseAndFlush();
        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                ...
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    {
                        var connString = new SqlConnectionStringBuilder(configuration["TestTemplate15DbConnection"]);
