...
namespace TestTemplate15.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                var sqlConnectionStringBuilder = new SqlConnectionStringBuilder(_configuration["TestTemplate15DbConnection"] ?? string.Empty);
            ...
            services.AddSwaggerGen(setupAction =>
            {
                ...
                setupAction.SwaggerDoc(
                    "TestTemplate15OpenAPISpecification",
                    new OpenApiInfo
                    {
                        Title = "TestTemplate15 API",
                        Version = "v1",
                        Description = "This API allows access to TestTemplate15.",
                ...
                setupAction.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "TestTemplate15.Api.xml"));
            });
            ...
            services.AddCors(o => o.AddPolicy("TestTemplate15Client", builder =>
            {
            ...
            services.AddMassTransit(x =>
            {
                ...
                x.AddEntityFrameworkOutbox<TestTemplate15DbContext>(o =>
                {
            ...
            services.AddTestTemplate15ApplicationHandlers();
            ...
            services
                .AddHealthChecks()
                .AddDbContextCheck<TestTemplate15DbContext>();
        }
        ...
        public void Configure(IApplicationBuilder app)
        {
            ...
            //    app.UseHsts();
            // }
            app.UseCors("TestTemplate15Client");
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/TestTemplate15OpenAPISpecification/swagger.json", "TestTemplate15 API");
