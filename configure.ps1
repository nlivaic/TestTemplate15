...
Write-Output "Please enter following information to configure TestTemplate15 application for local use."
...
TestTemplate15DbConnection=Data Source=testtemplate15.sql;Initial Catalog=TestTemplate15Db;Encrypt=False
TestTemplate15Db_Migrations_Connection=Data Source=host.docker.internal,1433;Initial Catalog=TestTemplate15Db;Encrypt=False
...
# Database username
$db_user_default = "TestTemplate15Db_Login"
